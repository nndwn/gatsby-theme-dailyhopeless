...
const Icons = ({icon, className, size, style}) => (
    <>
        {icon === "language" ?
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} css={style}>
            ...
            :icon === "heart" ? 
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" css={style}>
